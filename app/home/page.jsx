    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 text-center gap-4 mb-4">
      <div className="flex-1 flex flex-col justify-center items-center gap-4 p-10">
        <h1 className="text-5xl my-6">
          <span className="light:text-[#12100E] dark:text-[#8693AB] font-bold">
            Share
          </span>{" "}
          Your thoughts{" "}
          <span>
        ...
        <p className="text-3xl font-light">
          This site contains knowledge about programming languages.
        </p>
      ...
      <div className="flex-1 flex flex-col justify-center items-center gap-4">
        <Image
          src={hero}
          alt="hero"
          className="object-cover rounded-md h-auto w-auto animate-pulse duration-1000"
        />
      </div>
    </div>
  );
